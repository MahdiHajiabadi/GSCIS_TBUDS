...
public class PageRankWG {
  ...
  public static void main(String[] args) throws Exception {
    ...
    PageRankWG pr = new PageRankWG(input, niter, damping, eps);
    ...
    PrintStream ps = new PrintStream(new File(input+"_pageRank_WG" + ".txt"));
    ...
    Runtime.getRuntime().exec("sort -g -r -k2,2 "+basename+"_pageRank_WG"+".txt -o "+basename+"_pageRank_WG" + "-sorted" + ".txt").waitFor();
